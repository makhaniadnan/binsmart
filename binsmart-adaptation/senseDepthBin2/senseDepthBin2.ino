...
byte mac[]    = {  0x98, 0x4F, 0xEE, 0x01, 0xC7, 0xA5 };
IPAddress ip(192, 168, 21, 130);
IPAddress server(131, 159, 198, 160);
...
boolean reconnect() {
  if (client.connect("arduinoClient")) {
    ...
    client.publish("smartbin/bin2", SenseDistance);
    // ... and resubscribe
...
void loop()
{
 ...
 String msg2Send = "uss2:" + Distance_in + ":";
 msg2Send.toCharArray(SenseDistance, 50);
  if (!client.connected()) {
    long now = millis();
